...
- **Required documentation work when implemented:** review and update the governing public-feed/product/design/testing documentation as part of the correction so server-rendered, crawlable initial HTML becomes an explicit supported contract. Those documentation changes are deferred until this issue is promoted for implementation.
