...
Phase 0 documentation alignment, Phase 1 Application foundation, Phase 2 Database foundation, and Phase 3 Publication and Source configuration are complete with durable closeout validation. The repository is currently in Phase 4 — Collection eligibility and network safety.
