...
- `roadmap/mvp-roadmap.md` — Phase 0–21 sequence, tech-demo critical path, completed Phase 10 entry singleton correction and work through Phase 18, dependencies, non-goals, exit gates, current Phase 19 production operations, Phase 20 production-baseline handoff, and terminal Phase 21 codebase simplification/maintainability hardening.
