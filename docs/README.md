...
- `roadmap/mvp-roadmap.md` — Phase 0–20 sequence, tech-demo critical path, completed Phase 10 entry singleton correction and Phases 11–14, dependencies, non-goals, exit gates, and current Phase 15 Publication/Category/Relevance-administration scope.
...
The repository is currently in **Phase 15 — Publication and Relevance administration**. Phase 14 Source administration completed by explicit repository-owner acceptance on August 14, 2026. Its historical artifact remains BLOCKED/RED only because the Level 8 Cloudflare Access/direct-origin deployment observation was unavailable; the roadmap/testing contract moved that observation to Phase 19 without rewriting history or claiming it was observed. Phase 15 owns singleton Publication settings, Categories, and Relevance administration while preserving prior collection, identity, provenance, scheduling, and public-feed behavior.
