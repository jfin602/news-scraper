...
- `roadmap/mvp-roadmap.md` — Phase 0–20 sequence, tech-demo critical path, completed Phase 10 entry singleton correction and Phases 11–13, dependencies, non-goals, exit gates, and current Phase 14 Source-administration scope.
...
The repository is currently in **Phase 14 — Source administration**. Phase 14 owns the Cloudflare Access-protected Source/endpoint administration surface and the optional topic-independent Source RSS/Atom item admission filter while preserving prior collection, Relevance, identity, provenance, scheduling, and public-feed behavior.
