...
- Phase 2 supplies nullable `Article.summary` through the transport-independent distribution read model, and Phase 4 exposes it through the permanent v1 HTTP API. Visible summary presentation in the bundled/reference frontend remains this Proposed presentation enhancement.
